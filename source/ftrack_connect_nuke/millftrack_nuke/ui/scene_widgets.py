...
class SceneManagerWidget(BaseDockableWidget):
  ...
  def refresh(self):
    ...
    try:
      current_scene_version = N_AssetFactory.get_version_from_id(version_id, SceneIO)
...
class SceneVersionWidget(QtGui.QWidget):
  ...
  def set_scene_version(self, scene_version):
    ...
    self._stackLayout.setCurrentWidget(self._scene_versions_dict[scene_version.id])
    self._loading_asset_version.stop_anim()
...
class ThumbnailWidget(QtGui.QLabel):
  ...
  def update_image(self, image_path=None):
    ...
    pixmap_scaled = self._pixmap.scaled(self.size, QtCore.Qt.KeepAspectRatio)
...
class SingleSceneVersionWidget(QtGui.QWidget):
  ...
  def setupUI(self):
    ...
    self._scene_warning_box._warning_header.setTextFormat(QtCore.Qt.RichText)
    ...
    self._infos_layout.setWidget(0, QtGui.QFormLayout.LabelRole, asset_type_lbl)
    self._infos_layout.setWidget(0, QtGui.QFormLayout.FieldRole, self._asset_type)
    self._infos_layout.setWidget(1, QtGui.QFormLayout.LabelRole, status_lbl)
    self._infos_layout.setWidget(1, QtGui.QFormLayout.FieldRole, self._status)
    self._infos_layout.setWidget(2, QtGui.QFormLayout.LabelRole, publish_lbl)
    self._infos_layout.setWidget(2, QtGui.QFormLayout.FieldRole, self._owner)
    self._infos_layout.setWidget(3, QtGui.QFormLayout.LabelRole, date_lbl)
    self._infos_layout.setWidget(3, QtGui.QFormLayout.FieldRole, self._date)
    self._infos_layout.setWidget(4, QtGui.QFormLayout.LabelRole, availability_lbl)
    self._infos_layout.setWidget(4, QtGui.QFormLayout.FieldRole, self._availability)
    self._infos_layout.setWidget(5, QtGui.QFormLayout.LabelRole, comment_lbl)
    self._infos_layout.setWidget(5, QtGui.QFormLayout.FieldRole, self._comment)
  ...
  def initiate_scene_version(self):
    ...
    if tuple_editor is not None:
      ...
      self._editor.setTextInteractionFlags(QtCore.Qt.TextBrowserInteraction)
      self._editor.setOpenExternalLinks(True)
      date_edit_lbl = QtGui.QLabel("on", self)
      date_edit_lbl.setStyleSheet(self._css_lbl)
      self._date_edit = QtGui.QLabel(date_edit.strftime("%A, %d. %B %Y %I:%M%p"), self)
  ...
  def set_owner(self, owner):
    ...
    if thumbnail == None:
      thumbnail = os.environ["FTRACK_SERVER"] + "/img/userplaceholder.png"
    image = utilities.get_url_file(thumbnail)

    self._owner.setText("<a style='"+ self._css_value +"' href='mailto:"+ email +"'>"+ name +"</a>")
  ...
  def set_editor(self, editor):
    ...
    self._editor.setText("<a style='"+ self._css_value +"' href='mailto:"+ email +"'>"+ name +"</a>")
  ...
  def set_locker(self):
    ...
    locker.setText("<a style='"+ locker_css +"' href='mailto:"+ email +"'>"+ name +"</a>")
